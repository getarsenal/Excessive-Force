...
Filled in from three reference photographs and `python3 tools/survey.py karnak`
before the builder is written; checked against `node tools/blocks.mjs karnak` and
