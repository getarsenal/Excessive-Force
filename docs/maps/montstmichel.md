...
Filled in from three reference photographs and `python3 tools/survey.py montstmichel`
before the builder is written; checked against `node tools/blocks.mjs montstmichel` and
`node tools/postcard.mjs montstmichel` after.
