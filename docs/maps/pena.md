...
Filled in from three reference photographs and `python3 tools/survey.py pena`
before the builder is written; checked against `node tools/blocks.mjs pena` and
