...
| Dominant surface colour (as a material) | yellow ochre and red ochre render, grey granite terraces | 51 % LIMESTONE (yellow, and the whole terrace skin down to the footing), 15 % SANDSTONE (red), 27 % RUBBLE (the fill, hidden), SLATE roofs, TILE bands |
...
Measured: 6,651 stones at low (1,547 below the summit), 17,034 at high, 0
loose at both. The first terrace was 60 x 100 and its south-east corner stood
forty metres clear of the ridge on a bare footing band; it is now sized to the
crag's level top and yellow to the footing. `padRadius: 0`, `groundLevel: 'bake'`, `FOUND = -26` real
