...
export const THEATRES = [
  ...
  },
  {
    id: 'colosseum',
    iso: 'ITA',
    lx: 0, ly: 0,                    // TODO(colosseum) label offset on the campaign map
    city: 'ROME',
    lon: 12.4922, lat: 41.8902,
    no: 17,
    title: 'TODO(colosseum) THE CONTRACT TITLE',
    brief: 'TODO(colosseum) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(colosseum)',
  },
  {
    id: 'towerbridge',
    iso: 'GBR',
    lx: 0, ly: 0,                    // TODO(towerbridge) label offset on the campaign map
    city: 'LONDON',
    lon: -0.0761, lat: 51.5076,
    no: 18,
    title: 'TODO(towerbridge) THE CONTRACT TITLE',
    brief: 'TODO(towerbridge) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(towerbridge)',
  },
  {
    id: 'florence',
    iso: 'ITA',
    lx: 0, ly: 0,                    // TODO(florence) label offset on the campaign map
    city: 'FLORENCE',
    lon: 11.2560, lat: 43.7731,
    no: 19,
    title: 'TODO(florence) THE CONTRACT TITLE',
    brief: 'TODO(florence) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(florence)',
  },
  {
    id: 'segovia',
    iso: 'ESP',
    lx: 0, ly: 0,                    // TODO(segovia) label offset on the campaign map
    city: 'SEGOVIA',
    lon: -4.1180, lat: 40.9479,
    no: 20,
    title: 'TODO(segovia) THE CONTRACT TITLE',
    brief: 'TODO(segovia) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(segovia)',
  },
  {
    id: 'atomium',
    iso: 'BEL',
    lx: 0, ly: 0,                    // TODO(atomium) label offset on the campaign map
    city: 'BRUSSELS',
    lon: 4.3414, lat: 50.8949,
    no: 21,
    title: 'TODO(atomium) THE CONTRACT TITLE',
    brief: 'TODO(atomium) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(atomium)',
  },
  {
    id: 'tokyotower',
    iso: 'JPN',
    lx: 0, ly: 0,                    // TODO(tokyotower) label offset on the campaign map
    city: 'TOKYO',
    lon: 139.7454, lat: 35.6586,
    no: 22,
    title: 'TODO(tokyotower) THE CONTRACT TITLE',
    brief: 'TODO(tokyotower) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(tokyotower)',
  },
  {
    id: 'budapest',
    iso: 'HUN',
    lx: 0, ly: 0,                    // TODO(budapest) label offset on the campaign map
    city: 'BUDAPEST',
    lon: 19.0457, lat: 47.5070,
    no: 23,
    title: 'TODO(budapest) THE CONTRACT TITLE',
    brief: 'TODO(budapest) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(budapest)',
  },
  {
    id: 'sagrada',
    iso: 'ESP',
    lx: 0, ly: 0,                    // TODO(sagrada) label offset on the campaign map
    city: 'BARCELONA',
    lon: 2.1744, lat: 41.4036,
    no: 24,
    title: 'TODO(sagrada) THE CONTRACT TITLE',
    brief: 'TODO(sagrada) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(sagrada)',
  },
  {
    id: 'edinburgh',
    iso: 'GBR',
    lx: 0, ly: 0,                    // TODO(edinburgh) label offset on the campaign map
    city: 'EDINBURGH',
    lon: -3.1998, lat: 55.9486,
    no: 25,
    title: 'TODO(edinburgh) THE CONTRACT TITLE',
    brief: 'TODO(edinburgh) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(edinburgh)',
  },
  {
    id: 'neuschwanstein',
    iso: 'DEU',
    lx: 0, ly: 0,                    // TODO(neuschwanstein) label offset on the campaign map
    city: 'SCHWANGAU',
    lon: 10.7497, lat: 47.5576,
    no: 26,
    title: 'TODO(neuschwanstein) THE CONTRACT TITLE',
    brief: 'TODO(neuschwanstein) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(neuschwanstein)',
  },
  {
    id: 'montstmichel',
    iso: 'FRA',
    lx: 0, ly: 0,                    // TODO(montstmichel) label offset on the campaign map
    city: 'MONT-SAINT-MICHEL',
    lon: -1.5114, lat: 48.6360,
    no: 27,
    title: 'TODO(montstmichel) THE CONTRACT TITLE',
    brief: 'TODO(montstmichel) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(montstmichel)',
  },
  {
    id: 'pena',
    iso: 'PRT',
    lx: 0, ly: 0,                    // TODO(pena) label offset on the campaign map
    city: 'SINTRA',
    lon: -9.3906, lat: 38.7876,
    no: 28,
    title: 'TODO(pena) THE CONTRACT TITLE',
    brief: 'TODO(pena) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(pena)',
  },
  {
    id: 'hassan',
    iso: 'MAR',
    lx: 0, ly: 0,                    // TODO(hassan) label offset on the campaign map
    city: 'CASABLANCA',
    lon: -7.6326, lat: 33.6082,
    no: 29,
    title: 'TODO(hassan) THE CONTRACT TITLE',
    brief: 'TODO(hassan) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(hassan)',
  },
  {
    id: 'kuwait',
    iso: 'KWT',
    lx: 0, ly: 0,                    // TODO(kuwait) label offset on the campaign map
    city: 'KUWAIT CITY',
    lon: 48.0028, lat: 29.3899,
    no: 30,
    title: 'TODO(kuwait) THE CONTRACT TITLE',
    brief: 'TODO(kuwait) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(kuwait)',
  },
  {
    id: 'karnak',
    iso: 'EGY',
    lx: 0, ly: 0,                    // TODO(karnak) label offset on the campaign map
    city: 'LUXOR',
    lon: 32.6572, lat: 25.7188,
    no: 31,
    title: 'TODO(karnak) THE CONTRACT TITLE',
    brief: 'TODO(karnak) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(karnak)',
  },
  {
    id: 'forbidden',
    iso: 'CHN',
    lx: 0, ly: 0,                    // TODO(forbidden) label offset on the campaign map
    city: 'BEIJING',
    lon: 116.3907, lat: 39.9159,
    no: 32,
    title: 'TODO(forbidden) THE CONTRACT TITLE',
    brief: 'TODO(forbidden) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(forbidden)',
  },
  {
    id: 'gyeongbok',
    iso: 'KOR',
    lx: 0, ly: 0,                    // TODO(gyeongbok) label offset on the campaign map
    city: 'SEOUL',
    lon: 126.9771, lat: 37.5786,
    no: 33,
    title: 'TODO(gyeongbok) THE CONTRACT TITLE',
    brief: 'TODO(gyeongbok) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(gyeongbok)',
  },
  {
    id: 'watarun',
    iso: 'THA',
    lx: 0, ly: 0,                    // TODO(watarun) label offset on the campaign map
    city: 'BANGKOK',
    lon: 100.4888, lat: 13.7438,
    no: 34,
    title: 'TODO(watarun) THE CONTRACT TITLE',
    brief: 'TODO(watarun) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(watarun)',
  },
  {
    id: 'shwedagon',
    iso: 'MMR',
    lx: 0, ly: 0,                    // TODO(shwedagon) label offset on the campaign map
    city: 'YANGON',
    lon: 96.1496, lat: 16.7984,
    no: 35,
    title: 'TODO(shwedagon) THE CONTRACT TITLE',
    brief: 'TODO(shwedagon) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(shwedagon)',
  },
  {
    id: 'angkor',
    iso: 'KHM',
    lx: 0, ly: 0,                    // TODO(angkor) label offset on the campaign map
    city: 'SIEM REAP',
    lon: 103.8670, lat: 13.4125,
    no: 36,
    title: 'TODO(angkor) THE CONTRACT TITLE',
    brief: 'TODO(angkor) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(angkor)',
  },
  {
    id: 'borobudur',
    iso: 'IDN',
    lx: 0, ly: 0,                    // TODO(borobudur) label offset on the campaign map
    city: 'MAGELANG',
    lon: 110.2037, lat: -7.6079,
    no: 37,
    title: 'TODO(borobudur) THE CONTRACT TITLE',
    brief: 'TODO(borobudur) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(borobudur)',
  },
  {
    id: 'tikal',
    iso: 'GTM',
    lx: 0, ly: 0,                    // TODO(tikal) label offset on the campaign map
    city: 'TIKAL',
    lon: -89.6234, lat: 17.2218,
    no: 38,
    title: 'TODO(tikal) THE CONTRACT TITLE',
    brief: 'TODO(tikal) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(tikal)',
  },
  {
    id: 'teotihuacan',
    iso: 'MEX',
    lx: 0, ly: 0,                    // TODO(teotihuacan) label offset on the campaign map
    city: 'TEOTIHUACAN',
    lon: -98.8437, lat: 19.6925,
    no: 39,
    title: 'TODO(teotihuacan) THE CONTRACT TITLE',
    brief: 'TODO(teotihuacan) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(teotihuacan)',
  },
  {
    id: 'machupicchu',
    iso: 'PER',
    lx: 0, ly: 0,                    // TODO(machupicchu) label offset on the campaign map
    city: 'MACHU PICCHU',
    lon: -72.5450, lat: -13.1631,
    no: 40,
    title: 'TODO(machupicchu) THE CONTRACT TITLE',
    brief: 'TODO(machupicchu) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(machupicchu)',
  },
  {
    id: 'greatwall',
    iso: 'CHN',
    lx: 0, ly: 0,                    // TODO(greatwall) label offset on the campaign map
    city: 'BADALING',
    lon: 116.0200, lat: 40.3597,
    no: 41,
    title: 'TODO(greatwall) THE CONTRACT TITLE',
    brief: 'TODO(greatwall) three sentences: the place, what it is made of, what the player is paid for.',
    unlocks: [],
    unlockLine: 'TODO(greatwall)',
  },
];
